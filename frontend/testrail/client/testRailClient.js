...
class TestRailClient {
  ...
  async getCases(projectId) {
    ...
    // never match, which is why the UI suites showed as "not in TestRail" when they
    // were there all along. Loop until drained, like getTests. Older instances return
    // a plain array.
    const limit = 250;
    let offset = 0;
    const all = [];
